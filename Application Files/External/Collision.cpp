...
namespace Collision
{
    ...
    {
    public:
        OrientedBoundingBox (Player& Object) // Calculate the four points of the OBB from a transformed (scaled, rotated...) sprite
        {
    ...
    bool BoundingBoxTest(Player& Object1, Player& Object2) {
